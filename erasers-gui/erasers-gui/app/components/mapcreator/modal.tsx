        ...
        <>
            ...
            >
                <Box sx={style}>
                    ...
                    <Box p={1}>
                        <TextField label="position x" defaultValue={newValue["x"]} onChange={(e) => setNV("x", Number(e.target.value))} />
                        <TextField label="position y" defaultValue={newValue["y"]} onChange={(e) => setNV("y", Number(e.target.value))} />
                        <TextField label="height z" defaultValue={newValue["z"]} onChange={(e) => setNV("z", Number(e.target.value))} />
                        <TextField label="position theta" defaultValue={newValue["theta"]} onChange={(e) => setNV("theta", Number(e.target.value))} />
                    </Box>
                    <Box sx={{ position: 'absolute', bottom: 10, right: 10 }}>
            ...
            >
                <Box sx={style}>
                    ...
                    <Box sx={{ overflow: "auto", height: '100%' }}>
                        ...
                        <Box p={1}>
                            <TextField label="position x" defaultValue={inputValue["x"]} value={inputValue["x"]} onChange={(e) => setIV("x", Number(e.target.value))} />
                            <TextField label="position y" defaultValue={inputValue["y"]} value={inputValue["y"]} onChange={(e) => setIV("y", Number(e.target.value))} />
                            <TextField label="height z" defaultValue={inputValue["z"]} value={inputValue["z"]} onChange={(e) => setIV("z", Number(e.target.value))} />
                            <TextField label="position theta" defaultValue={inputValue["theta"]} value={inputValue["theta"]} onChange={(e) => setIV("theta", Number(e.target.value))} />
                        </Box>
                    </Box>
                    <Box sx={{ position: 'absolute', bottom: 10, right: 10 }}>
